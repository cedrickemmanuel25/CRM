...
<li class="mt-6 mb-3 px-3">
    <span class="text-[10px] font-bold uppercase tracking-widest text-gray-500">Rapports</span>
</li>
<li>
    <a href="{{ route('support.reports') }}" 
       class="group flex items-center gap-x-2.5 rounded-lg py-1.5 px-2.5 text-xs font-medium leading-6 transition-all duration-200 
       {{ request()->routeIs('support.reports') 
            ? 'bg-gradient-to-r from-indigo-600 to-blue-600 text-white shadow-md shadow-indigo-500/20 translate-x-1' 
            : 'text-gray-600 hover:text-gray-900 hover:bg-gray-200' }}">
        <svg class="h-5 w-5 shrink-0 transition-transform duration-200 {{ request()->routeIs('support.reports') ? 'scale-110' : 'group-hover:scale-110' }}" 
             fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
