    ...
    <li>
        <a href="{{ route($link['route']) }}" 
           ...
           {{ request()->routeIs($link['route']) || request()->routeIs(explode('.', $link['route'])[0] . '.*') 
                ...
                : 'text-gray-600 hover:text-gray-900 hover:bg-gray-200' }} gap-x-2.5">
            ...
            <span x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 -translate-x-2" x-transition:enter-end="opacity-100 translate-x-0">
                {{ $link['label'] }}
            </span>
...
<li>
    <a href="{{ route($link['route']) }}" 
       ...
       {{ request()->routeIs($link['route']) || request()->routeIs($link['route'].'*') 
            ? 'bg-gradient-to-r from-indigo-600 to-blue-600 text-white shadow-md shadow-indigo-500/20 translate-x-1' 
            : 'text-gray-600 hover:text-gray-900 hover:bg-gray-200' }} justify-between">
