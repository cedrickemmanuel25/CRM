<div x-data="{ 
    ...
    <button @click="open = !open" class="bg-white p-1 rounded-full text-slate-400 hover:text-slate-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 relative">
        ...
        <div x-show="count > 0" class="absolute top-0 right-0 -mr-1 -mt-1 w-4 h-4 bg-red-500 rounded-full flex items-center justify-center animate-pulse shadow-sm ring-2 ring-white">
