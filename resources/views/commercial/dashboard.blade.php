                        ...
                        <table class="w-full text-sm">
                            ...
                            <tbody class="divide-y divide-slate-100">
                                ...
                                <tr class="hover:bg-slate-50/30 transition-colors group">
                                    <td class="px-8 py-4 font-bold text-slate-900">{{ $opp->titre }}</td>
                                    <td class="px-8 py-4 text-slate-500 font-medium">{{ $opp->contact->nom_complet ?? 'N/A' }}</td>
                                ...
                                @empty
                                <tr>
                                    <td colspan="3" class="px-8 py-10 text-center text-slate-400 italic font-medium">Aucune opportunité prioritaire détectée.</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
